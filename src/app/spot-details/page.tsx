...
const risks = ["No Inputs Provided", "Low Risk", "High Risk"]

const initialArrivalInfo = {
    'aspect': "", 'elevation': "", 'lat': 0, 'long': 0, "date": "", 'risk': risks[0]
}
...
export default function SpotDetails() {
    ...
    async function onSubmit() {
        ...
        try {
            ...
            risk = risk_probability < 0.3 ? risks[1] : risks[2]
        } catch (error) {
            console.log(error)
            risk = risks[0]
        }
    ...
    return (<LocalizationProvider dateAdapter={AdapterDayjs}>
            <Container maxWidth="sm" sx={{marginTop: '5rem', marginBottom: '5rem'}}>
                <Box
                    component="form"
                    sx={{
